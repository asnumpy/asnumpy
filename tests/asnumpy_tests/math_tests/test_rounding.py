...
@pytest.mark.xfail(reason="[FIXABLE] dtype promotion: rint on int32/64 outputs inconsistent dtype vs NumPy", strict=True)
...
@pytest.mark.xfail(reason="[FIXABLE] aclnnFix only supports float32, auto-cast needed for other dtypes", strict=True)
...
@pytest.mark.xfail(reason="[FIXABLE] aclnnCeil only supports float32/64, auto-cast needed for int dtypes", strict=True)
@testing.for_dtypes([numpy.int32, numpy.int64])
...
@pytest.mark.xfail(reason="[FIXABLE] aclnnTrunc only supports float32, auto-cast needed for other dtypes", strict=True)
@testing.for_dtypes([numpy.float64, numpy.int32])
