...
@pytest.mark.xfail(condition=True, reason="[FIXABLE] C++ core missing aclDataType mapping for float16", strict=True)
...
@pytest.mark.xfail(reason="[FIXABLE] aclnnSin does not support Int32, auto-cast needed", strict=True)
...
@pytest.mark.xfail(reason="[FIXABLE] aclnnArctan2 does not support Int32, auto-cast needed", strict=True)
@testing.for_dtypes([numpy.int32])
@testing.numpy_asnumpy_array_equal()
