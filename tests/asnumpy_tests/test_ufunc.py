...
class TestOp:
    ...
    def test_parse_loop_table_input_mismatch_raises(self):
    ...
    def test_parse_loop_table_output_mismatch_raises(self):
...
class TestWeakScalar:
    ...
    def test_get_max_array_dtype_same_kind_float(self):
    ...
    def test_get_max_array_dtype_same_kind_int(self):
